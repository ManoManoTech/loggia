"""Logging configuration sample, obtained from radiologist-collector-python"""
...
from mm_logs.constants import GUNICORN_HYPERCORN_KEY_RE, HYPERCORN_ATTRIBUTES_MAP, SAFE_HEADER_ATTRIBUTES
from mm_logs.utils.dictutils import del_if_possible, mv_attr
...
class CustomJsonFormatter(JsonFormatter):
    ...
    def add_fields(self, log_record: dict[str, Any], record: LogRecord, message_dict: dict[str, Any]) -> None:
        ...
        log_record["service"] = getenv("DD_SERVICE")
        ...
        xtra_ks = [k for k in log_record.keys() if k.startswith(("x-", "sec-"))]
